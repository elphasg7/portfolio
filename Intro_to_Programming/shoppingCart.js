...
function displayTotal() {
    ...
    //document.getElementById("receipt").innerHTML = nums[i] + ". " + items[i] + " x " + quantities[i] + " = R" + (prices[i] * quantities[i]).toFixed(2) + "<br></br>";
    //}
...
function display_all() {
    ...
    myTable += "<th style='width: 100px; color: red; text-align: center;'>Add</th>";
    myTable += "<th style='width: 100px; color: red; text-align: center;'>Remove</th>";
    // myTable += "<th style='width: 100px; color: red; text-align: right;'>Checkout</th>";
